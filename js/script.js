const ApiKey = "0ed605e6161c42efb0d5df6400c26396";
...
const detailPoin = `${baseUrl}teams`;
   ...
   // contents.innerHTML = "ini" + id + url;
    ...
    fetch(id, fetchHeader)
        ...
        .then(resJson => {
            ShowModal.innerHTML=`
            <center>
            <h3>Detail Informasi Tim Liga Inggris</h3>
            </center>
                    ...
                    <img src = ${resJson.crestUrl}></img>
                        ...
                        <p>
                           Short Name   : ${resJson.shortName}<br>
                            ...
                            Club Color  : ${resJson.clubColors} <br>
                        </p>
                    </div>
                </div></center>
